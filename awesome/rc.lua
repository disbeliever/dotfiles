...
for s = 1, screen.count() do
	...
	awful.tag.setproperty(tags[s][3], "mwfact", 0.91)
    -- tags[s] = awful.tag({ "dev", "www", "net", 4, 5, 6, 7, 8, 9 }, s, tags.layout)
end
-- }}}
...
root.buttons(awful.util.table.join(
    ...
    awful.button({ }, 4, awful.tag.viewnext),
    awful.button({ }, 5, awful.tag.viewprev),
	awful.button({ }, 10, function() awful.util.spawn_with_shell("notify-send hello") end)
))
-- }}}
...
awful.rules.rules = {
    ...
    --  properties = { floating = true } },
    { rule = { class = "Krusader", name = "Перемещение" },
      properties = { floating = true } },
    { rule = { class = "Deadbeef" },
